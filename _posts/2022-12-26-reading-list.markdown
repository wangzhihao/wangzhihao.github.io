...
1. *PAXOS*: Lamport, Leslie (https://en.wikipedia.org/wiki/Leslie_Lamport). "The part-time parliament." Concurrency: the Works of Leslie Lamport. 2019. 277-317. [paper (https://lamport.azurewebsites.net/pubs/lamport-paxos.pdf), impl (https://code.amazon.com/packages/LSD/blobs/mainline-2.0/--/src/lsd/paxos/PaxosLSD.java), 30% read]
...
5. *Consistency models*. https://jepsen.io/consistency [https://quip-amazon.com/ajlKAVvFZfc9/Consistency-Models]
...
1. java (https://github.com/openjdk/jdk) [https://quip-amazon.com/JJbDA2Z6Fz6v/java-code-analysis] (LoC: 16M)
2. kafka (https://github.com/apache/kafka) by Kreps, Jay (https://twitter.com/jaykreps?lang=en) et al. [https://quip-amazon.com/IUQOAlCppcA4/Kafka-Code-Analysis] (LoC: 734K)
3. zookeeper (https://github.com/apache/zookeeper) [https://quip-amazon.com/Gx4aATuBiGb5/Zookeeper-Analysis] (LoC: 180K)
...
9. RUST Learning resourcesfrom Amazon wiki (https://w.amazon.com/bin/view/RustLang#HLearningRust)
